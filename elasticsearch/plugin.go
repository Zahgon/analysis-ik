// Package elasticsearch registers the IK analyzer under the names Elasticsearch knows
// it by, and resolves its dictionaries out of an Elasticsearch installation.
//
// Elasticsearch loads plugins as JVM classes, which a Go build cannot produce, so
...
// PluginName is the name Elasticsearch knows the plugin by. It is also the name of
